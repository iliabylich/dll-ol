...
{
    printf("assert_eq_char(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_char(char lhs, char rhs)
{
    printf("assert_ne_char(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_short(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_short(short lhs, short rhs)
{
    printf("assert_ne_short(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_int(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_int(int lhs, int rhs)
{
    printf("assert_ne_int(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_long(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_long(long lhs, long rhs)
{
    printf("assert_ne_long(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_long_long(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_long_long(long long lhs, long long rhs)
{
    printf("assert_ne_long_long(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_int8_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_int8_t(int8_t lhs, int8_t rhs)
{
    printf("assert_ne_int8_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_int16_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_int16_t(int16_t lhs, int16_t rhs)
{
    printf("assert_ne_int16_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_int32_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_int32_t(int32_t lhs, int32_t rhs)
{
    printf("assert_ne_int32_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
...
{
    printf("assert_eq_int64_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
void assert_ne_int64_t(int64_t lhs, int64_t rhs)
{
    printf("assert_ne_int64_t(%llu, %llu)\n", (uint64_t)lhs, (uint64_t)rhs);
}
